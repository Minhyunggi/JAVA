...
class Employee {
    ...
    public static int right;
    public static void sum(int period, int right){ // 위와같이 파라미터부분을 지워버리고 sout 부분에 Calculator.Left + Calculator.right 를 넣어서
                                                    // 밑에 main 부분에서 Left , right 값을 정해주는 방식으로도 할수있고
